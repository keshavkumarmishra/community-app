(function (module) {
    mifosX.controllers = _.extend(module, {
        FeeStructureController: function (scope, resourceFactory, location) {
            scope.fees = [];
            scope.actualClients = [];
            scope.searchText = "";
            scope.searchResults = [];
    ...
    mifosX.ng.application.controller('FeeStructureController', ['$scope', 'ResourceFactory', '$location', mifosX.controllers.FeeStructureController]).run(function ($log) {
        $log.info("FeeStructureController initialized");
    });
}(mifosX.controllers || {}));