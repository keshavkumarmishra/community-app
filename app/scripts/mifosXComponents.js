define(['Q', 'underscore', 'mifosX'], function (Q) {
    var components = {
        ...
        controllers: [
            ...
            'calendar/CreateCalendarController',
            'calendar/CalendarController',
            'calendar/ViewCalendarController',
            'calendar/EditCalendarCalendar',
            'feestructure/CreateFeestructureController',
            'feestructure/EditFeeStructureController',
            'feestructure/FeeStructureController',
            'feestructure/ViewFeeStructureController',
            'organization/EmployeeEducationController',
            'organization/EmployeeExperienceController',
            'organization/EditStaffEducationController',
            'organization/EditStaffExperienceController',
            'groups/ViewStudentAttendenceController',
            'groups/ViewStudentDetailAttendenceController',
            'groups/EditStudentAttendenceDetailsController',
            'organization/ViewLeaveManagementController',
            'organization/EditLeaveManagementController',
            'organization/CreateLeaveManagementController',
            'organization/LeaveManagementController',
            'organization/LeaveApplyController',
